...
public class SEProvider {
  ...
  public static void print(byte[] buf, short start, short length) {
    // Uncomment the following for JCardSim.
  ...
  public short bufferData(byte[] inData, short inDataStart, short inDatalen,
      byte mode, byte[] scratchpad, short scratchpadOff, short scratchpadLen) {
    ...
    short tagOffset = 2;
    // Copy tag and input to scratch pad and then copy last combined 16 bytes from scratch pad and input to tag.
  ...
  public short doAesGcmOperation(
    ...
    if (!justUpdate) {
      ...
      try {
        inDataLen = bufferData(inData, inDataStart, inDataLen, (byte) mode, outData, outDataStart,
  ...
  public short generateCredKeyCert(ECPrivateKey attestKey, ECPublicKey credPubKey,
    ...
    return mX509CertHandler.generateCredKeyCert(attestKey, this, credPubKey,
  ...
  public short generateSigningKeyCert(ECPublicKey signingPubKey, ECPrivateKey attestKey,
      ...
      byte[] buf, short start, short len,
      byte[] scratch, short scratchStart, short scratchLen) {
    return mX509CertHandler.generateSigningKeyCert(this, signingPubKey, attestKey,
        notBefore, notBeforeStart, notBeforeLen,
        notAfter, notAfterStart, notAfterLen,
        buf, start, len,
        scratch, scratchStart, scratchLen);
