...
public class NdefTagApplet extends Applet implements ExtendedLength {
    ...
    private void processSelect(APDU apdu) {
        ...
        case FILE_ID_NDEF_FILE:
            ...
            // selected. Everytime Ndef File is selected new device Engagement data must be
            // generated and hence new Ndef data file needs to be generated.
            MdlService mdl =
    ...
    private void processReadBinary(APDU apdu) {
        ...
        // Total length of the NDEF File includes payload and preceding two bytes for the file
        // length.
