...
public class CBOREncoder extends CBORBase {
     ...
     * actual byte string is not copied into the buffer (offset will be set to the location after
     * the byte string)
     *
     ...
     * @return The number of bytes written to buffer
     */
    public short encodeUInt16(short value) { return encodeValue(TYPE_UNSIGNED_INTEGER, value); }
