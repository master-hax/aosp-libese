...
public class MDoc {
    ...
    private final KeyPair mCredentialKey;
    ...
    public void createPackage(short size) {
        MdlPresentationPkgStore pkgStore = getPkgStore();
        pkgStore.createPackage(mSlotId, size);
    }
    ...
    public void reserve() { mReserved = true; }

    public void release() { mReserved = false; }

    public boolean isReserved() { return mReserved; }

    public KeyPair getCredentialKey() { return mCredentialKey; }
    ...
    public AESKey getStorageKey() { return mStorageKey; }

    public boolean isProvisioned() { return mProvisioned; }

    public boolean isTestCredential() { return mTestCred[0]; }
}
