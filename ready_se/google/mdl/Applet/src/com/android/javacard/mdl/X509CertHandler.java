...
public class X509CertHandler {
    ...
    private final byte[] androidExtn = {0x06, 0x0A,       0X2B, 0X06, 0X01, 0X04,
                                        0X01, (byte)0XD6, 0X79, 0X02, 0X01, 0X11};
    // TODO remove this once ROT solution is clarified.
    private final byte[] dummyROT = {
        (byte)0xBF, (byte)0x85, 0x40, 0x4C, 0x30, 0x4A, 0x04, 0x20, 0x00, 0x00, 0x00, 0x00,
        0x00,       0x00,       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,       0x00,       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,       0x00,       0x00, 0x00, 0x01, 0x01, 0x00, 0x0A, 0x01, 0x02, 0x04, 0x20,
        0x00,       0x00,       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,       0x00,       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    /**
     * version [0] (1 elem) Version INTEGER 2 serialNumber CertificateSerialNumber INTEGER 1
     * signature AlgorithmIdentifier SEQUENCE (1 elem) algorithm OBJECT
     * IDENTIFIER 1.2.840.10045.4.3.2 ecdsaWithSHA256 (ANSI X9.62 ECDSA algorithm with SHA256)
     * issuer Name SEQUENCE (5 elem) RelativeDistinguishedName SET (1 elem) AttributeTypeAndValue
     * SEQUENCE (2 elem) type AttributeType OBJECT IDENTIFIER 2.5.4.6 countryName (X.520 DN
     * component) value AttributeValue PrintableString US RelativeDistinguishedName SET (1 elem)
     * AttributeTypeAndValue SEQUENCE (2 elem) type AttributeType OBJECT IDENTIFIER 2.5.4.8
     * stateOrProvinceName (X.520 DN component) value AttributeValue UTF8String California
     * RelativeDistinguishedName SET (1 elem) AttributeTypeAndValue SEQUENCE (2 elem) type
     * AttributeType OBJECT IDENTIFIER 2.5.4.10 organizationName (X.520 DN component) value
     * AttributeValue UTF8String Google, Inc. RelativeDistinguishedName SET (1 elem)
     * AttributeTypeAndValue SEQUENCE (2 elem) type AttributeType OBJECT IDENTIFIER 2.5.4.11
     * organizationalUnitName (X.520 DN component) value AttributeValue UTF8String Android
     * RelativeDistinguishedName SET (1 elem) AttributeTypeAndValue SEQUENCE (2 elem) type
     * AttributeType OBJECT IDENTIFIER 2.5.4.3 commonName (X.520 DN component) value AttributeValue
     * UTF8String Android Keystore Software Attestation Intermediate
     */
    private final byte[] credKeyCertCommon_1 = {
        (byte)0xA0, 0x03, 0x02,       0x01, 0x02,       0x02, 0x01, 0x01, 0x30, 0x0A, 0x06,
        0x08,       0x2A, (byte)0x86, 0x48, (byte)0xCE, 0x3D, 0x04, 0x03, 0x02, 0x30, (byte)0x81,
        (byte),
    };
    ...
    */
     ...
     * SEQUENCE (2 elem) type AttributeType OBJECT IDENTIFIER 2.5.4.3 commonName (X.520 DN
     * component) value AttributeValue UTF8String Android Identity Credential Key
     * subjectPublicKeyInfo SubjectPublicKeyInfo SEQUENCE (2 elem) algorithm AlgorithmIdentifier
     * SEQUENCE (2 elem) algorithm OBJECT IDENTIFIER 1.2.840.10045.2.1 ecPublicKey (ANSI X9.62
     * public key type) parameters ANY OBJECT IDENTIFIER 1.2.840.10045.3.1.7 prime256v1 (ANSI X9.62
     * named elliptic curve) <Add BIT STRING containing the CredKey's public_key following the
     * above>
     */
    private final byte[] credKeyCommonName = {
        0x30, 0x2A, 0x31, 0x28, 0x30, 0x26, 0x06, 0x03, 0x55, 0x04, 0x03, 0x0C, 0x1F, 0x41, 0x6E,
        0x64, 0x72, 0x6F, 0x69, 0x64, 0x20, 0x49, 0x64, 0x65, 0x6E, 0x74, 0x69, 0x74, 0x79, 0x20,
        0x43, 0x72, 0x65, 0x64, 0x65, 0x6E, 0x74, 0x69, 0x61, 0x6C, 0x20, 0x4B, 0x65, 0x79,
    };
     ...
     * extension) critical BOOLEAN true extnValue OCTET STRING (4 byte) 03020780 BIT STRING (1 bit)
     * 1
     */
    private final byte[] keyUsage = {
        0x30, 0x0E,       0x06, 0x03, 0x55, 0x1D, 0x0F, 0x01,
        0x01, (byte)0xFF, 0x04, 0x04, 0x03, 0x02, 0x07, (byte)0x80,
    };
     ...
     * 1.2.840.10045.4.3.2 ecdsaWithSHA256 (ANSI X9.62 ECDSA algorithm with SHA256) SEQUENCE (1
     * elem) SET (1 elem) SEQUENCE (2 elem) OBJECT IDENTIFIER 2.5.4.3 commonName (X.520 DN
     * component) Offset: 33 Length: 2+3 Value: 2.5.4.3 commonName X.520 DN component UTF8String
     * Android Identity Credential Key
     */
    private final byte[] certSigningKeyCommon_1 = {
        (byte)0xA0, 0x03, 0x02,       0x01, 0x02, 0x02, 0x01, 0x01, 0x30, 0x0A, 0x06, 0x08, 0x2A,
        (byte)0x86, 0x48, (byte)0xCE, 0x3D, 0x04, 0x03, 0x02, 0x30, 0x2A, 0x31, 0x28, 0x30, 0x26,
        0x06,       0x03, 0x55,       0x04, 0x03, 0x0C, 0x1F, 0x41, 0x6E, 0x64, 0x72, 0x6F, 0x69,
        0x64,       0x20, 0x49,       0x64, 0x65, 0x6E, 0x74, 0x69, 0x74, 0x79, 0x20, 0x43, 0x72,
        0x65,       0x64, 0x65,       0x6E, 0x74, 0x69, 0x61, 0x6C, 0x20, 0x4B, 0x65, 0x79,
    };

    /**
     * SEQUENCE (1 elem) SET (1 elem) SEQUENCE (2 elem) OBJECT IDENTIFIER 2.5.4.3 commonName (X.520
     * DN component) X.520 DN component UTF8String Android Identity Credential Authentication Key
     * SEQUENCE (2 elem) SEQUENCE (2 elem) OBJECT IDENTIFIER 1.2.840.10045.2.1 ecPublicKey (ANSI
     * X9.62 public key type) OBJECT IDENTIFIER 1.2.840.10045.3.1.7 prime256v1 (ANSI X9.62 named
     * elliptic curve) <followed by BIT STRING containing the public key>
     */
    private final byte[] certSigningKeyCommon_2 = {
        0x30,       0x39, 0x31,       0x37, 0x30, 0x35, 0x06, 0x03, 0x55, 0x04,       0x03,
        0x0C,       0x2E, 0x41,       0x6E, 0x64, 0x72, 0x6F, 0x69, 0x64, 0x20,       0x49,
        0x64,       0x65, 0x6E,       0x74, 0x69, 0x74, 0x79, 0x20, 0x43, 0x72,       0x65,
        0x64,       0x65, 0x6E,       0x74, 0x69, 0x61, 0x6C, 0x20, 0x41, 0x75,       0x74,
        0x68,       0x65, 0x6E,       0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6F,       0x6E,
        0x20,       0x4B, 0x65,       0x79, 0x30, 0x59, 0x30, 0x13, 0x06, 0x07,       0x2A,
        (byte)0x86, 0x48, (byte)0xCE, 0x3D, 0x02, 0x01, 0x06, 0x08, 0x2A, (byte)0x86, 0x48,
        (byte)0xCE, 0x3D, 0x03,       0x01, 0x07,
    };

    private final byte[] signingKey_common_name = {
        0x30, 0x39, 0x31, 0x37, 0x30, 0x35, 0x06, 0x03, 0x55, 0x04, 0x03, 0x0C, 0x2E, 0x41, 0x6E,
        0x64, 0x72, 0x6F, 0x69, 0x64, 0x20, 0x49, 0x64, 0x65, 0x6E, 0x74, 0x69, 0x74, 0x79, 0x20,
        0x43, 0x72, 0x65, 0x64, 0x65, 0x6E, 0x74, 0x69, 0x61, 0x6C, 0x20, 0x41, 0x75, 0x74, 0x68,
        0x65, 0x6E, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x4B, 0x65, 0x79};
    ...
    private short pushBytes(byte[] stack, short stackPtr, short stackLen, byte[] buf, short start,
                            short len) {
        stackPtr -= len;
        if (buf != null) {
    ...
    private short pushIntegerTag(byte[] stack, short stackPtr, short stackLen, byte[] val,
                                 short valStart, short valLen, short tag) {
    ...
    private short pushBooleanTag(byte[] stack, short stackPtr, short stackLen, byte boolVal,
                                 short tag) {
    ...
    private short pushOctetTag(byte[] stack, short stackPtr, short stackLen, byte[] val,
                               short valStart, short valLen, short tag) {
        short lastStackPtr = stackPtr;
    ...
    private short pushHwEnforcedParams(byte[] stack, short stackPtr, short stackLen,
                                       boolean testCredential, byte[] osVersion,
                                       short osVersionStart, short osVersionLen,
        ...
        if (osPatchLevel != null) {
            stackPtr = pushIntegerTag(stack, stackPtr, stackLen, osPatchLevel, osPatchLevelStart,
                                      osPatchLevelLen, (short)706);
        }
        // os version
        if (osVersion != null) {
            stackPtr = pushIntegerTag(stack, stackPtr, stackLen, osVersion, osVersionStart,
                                      osVersionLen, (short)705);
        }
        // Root Of Trust
        stackPtr = pushRoT(stack, stackPtr, stackLen);

        // Finally fixed set of parameters
        stackPtr = pushBytes(stack, stackPtr, stackLen, credKeyCertExtFixed, (short)0,
    ...
    private short pushSwEnforcedParams(byte[] stack, short stackPtr, short stackLen,
                                       byte[] creationDateTime, short creationDateTimeStart,
                                       short creationDateTimeLen, byte[] attAppId,
                                       short attAppIdStart, short attAppIdLen) {
        short lastStackPtr = stackPtr;
        // attestation app id
        if (attAppId != null) {
            stackPtr = pushOctetTag(stack, stackPtr, stackLen, attAppId, attAppIdStart, attAppIdLen,
                                    (short)709);
        }
        if (creationDateTime != null) {
            stackPtr = pushIntegerTag(stack, stackPtr, stackLen, creationDateTime,
                                      creationDateTimeStart, creationDateTimeLen, (short)701);
        }
    ...
    private short pushAndroidExtension(byte[] stack, short stackPtr, short stackLen,
                                       ...
                                       byte[] osPatchLevel, short osPatchLevelStart,
                                       short osPatchLevelLen, byte[] creationDateTime,
        ...
        short lastStackPtr = stackPtr;
        // First hw enforced.
        stackPtr = pushHwEnforcedParams(stack, stackPtr, stackLen, testCredential, osVersion,
                                        osVersionStart, osVersionLen, osPatchLevel,
                                        osPatchLevelStart, osPatchLevelLen);

        // Now SW enforced
        stackPtr =
            pushSwEnforcedParams(stack, stackPtr, stackLen, creationDateTime, creationDateTimeStart,
                                 creationDateTimeLen, attAppId, attAppIdStart, attAppIdLen);
        ...
        stackPtr = pushSequenceHeader(stack, stackPtr, stackLen, (short)(lastStackPtr - stackPtr));
        stackPtr =
            pushOctetStringHeader(stack, stackPtr, stackLen, (short)(lastStackPtr - stackPtr));
        stackPtr =
    ...
    private short pushInteger(byte[] stack, short stackPtr, short stackLen, byte[] buf, short start,
                              short len) {
        short last = stackPtr;
        byte index = 0;
    ...
    private short pushBitStringHeader(byte[] stack, short stackPtr, short stackLen, byte unusedBits,
                                      short len) {
    ...
    private short pushOctetString(byte[] stack, short stackPtr, short stackLen, byte[] buf,
    ...
    //         attestationChallenge       OCTET_STRING, # Tag::ATTESTATION_CHALLENGE from
    //         attestParams uniqueId                   OCTET_STRING, # Empty unless key has
    //         Tag::INCLUDE_UNIQUE_ID softwareEnforced           AuthorizationList, # See below
    ...
    private short pushExtensions(byte[] stack, short stackPtr, short stackLen, byte[] osVersion,
                                 short osVersionStart, short osVersionLen, byte[] osPatchLevel,
                                 short osPatchLevelStart, short osPatchLevelLen,
                                 byte[] creationDateTime, short creationDateTimeStart,
                                 short creationDateTimeLen, byte[] attAppId, short attAppIdStart,
                                 short attAppIdLen, boolean testCredential, byte[] challenge,
                                 short challengeStart, short challengeLen) {
        short lastStackPtr = stackPtr;
        stackPtr = pushAndroidExtension(stack, stackPtr, stackLen, osVersion, osVersionStart,
                                        osVersionLen, osPatchLevel, osPatchLevelStart,
                                        osPatchLevelLen, creationDateTime, creationDateTimeStart,
                                        creationDateTimeLen, attAppId, attAppIdStart, attAppIdLen,
                                        challenge, challengeStart, challengeLen, testCredential);
    ...
    private short pushPubKey(byte[] stack, short stackPtr, short stackLen, ECPublicKey credPubKey,
    ...
    private short pushValidity(byte[] stack, short stackPtr, short stackLen, byte[] notBefore,
                               short notBeforeStart, short notBeforeLen, byte[] notAfter,
    ...
    public short generateCredKeyCert(
        ECPrivateKey attestKey, SEProvider seProvider, ECPublicKey credPubKey, byte[] osVersion,
        short osVersionStart, short osVersionLen, byte[] osPatchLevel, short osPatchLevelStart,
        short osPatchLevelLen, byte[] challenge, short challengeStart, short challengeLen,
        byte[] notBefore, short notBeforeStart, short notBeforeLen, byte[] notAfter,
        short notAfterStart, short notAfterLen, byte[] creationDateTime,
        short creationDateTimeStart, short creationDateTimeLen, byte[] attAppId,
        short attAppIdStart, short attAppIdLen, boolean testCredential, byte[] buf, short start,
        short len, byte[] scratch, short scratchStart, short scratchLen) {
        short stackPtr = len;
        ...
        // push extension
        stackPtr = pushExtensions(buf, stackPtr, (short)(len - start), osVersion, osVersionStart,
                                  osVersionLen, osPatchLevel, osPatchLevelStart, osPatchLevelLen,
                                  creationDateTime, creationDateTimeStart, creationDateTimeLen,
                                  attAppId, attAppIdStart, attAppIdLen, testCredential, challenge,
        ...
        stackPtr = pushValidity(buf, stackPtr, len, notBefore, notBeforeStart, notBeforeLen,
    ...
    public short generateSigningKeyCert(SEProvider seProvider, ECPublicKey signingPubKey,
                                        ECPrivateKey attestKey, byte[] notBefore,
                                        short notBeforeStart, short notBeforeLen, byte[] notAfter,
                                        short notAfterStart, short notAfterLen, byte[] buf,
                                        short start, short len, byte[] scratch, short scratchStart,
                                        short scratchLen) {
     ...
     * tagValIndex;
     */
    private short readSign(byte[] buf, short start, short end, short[] retVal, byte[] scratch,
        ...
        // first byte in the bit string should be zero in case of ecDSA signature as there should
        // not be any unused bytes.
        if (buf[retVal[3]] != 0) {
            return -1;
        }
     ...
     *     object - retValues[1] - tag id. - retValues[2] - tag length - retValues[3] = start index
     * of TLV value field.
    ...
    public short traverseChain(short parentTag, short tag, byte[] val, short valStart, short valLen,
                               byte[] mem, short index, short len, short[] retValues) {
        short end = (short)(index + len);  // end of the credentials.
        // Read the key sets one by one - index points to beginning of the key set and the end
        // points to end of all the key sets.
