...
public class PresentationPkgStore implements MdlPresentationPkgStore {
    ...
    private PresentationPkgStore() { mInstance = this; }
    ...
    public void configure(SEProvider se, MdlSpecifications mdlSpecs, short maxSlots,
                          byte preAllocatedDocCount, short maxDocumentSize) {
