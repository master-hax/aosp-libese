...
public class CBORBase {
    ...
    public final byte[] DIRECT_ACCESS_PROVISIONING_APPLET_ID = {(byte)0xA0, 0x00, 0x00, 0x02, 0x48,
                                                                0x00,       0x01, 0x01, 0x01};
    ...
    private byte[] getCurrentApduBuffer() {
        ...
        if (aid != null && aid.equals(DIRECT_ACCESS_PROVISIONING_APPLET_ID, (short)0,
    ...
    public final short getCurrentOffset() { return mStatusWords[0]; }

    /** Returns the length of the current buffer stream. */
    public final short getBufferLength() { return mStatusWords[1]; }
     ...
     */
    public byte getRawByte() { return getBuffer()[mStatusWords[0]]; }
