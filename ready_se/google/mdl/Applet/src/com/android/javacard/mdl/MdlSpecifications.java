...
public class MdlSpecifications {
    ...
    public static final byte EC_P256_COSE_KEY_SIZE =
        (2 * (KeyBuilder.LENGTH_EC_FP_256 / 8) + 1) + 16;
    public static final short MDL_ERR_NOT_FOUND = 10;
    // Mdl doc type
    // Text String with "org.iso.18013.5.1.mDL"
    public final byte[] mdlDocType = {
        0x75, 0x6f, 0x72, 0x67, 0x2e, 0x69, 0x73, 0x6f, 0x2e, 0x31, 0x38,
        0x30, 0x31, 0x33, 0x2e, 0x35, 0x2e, 0x31, 0x2e, 0x6d, 0x44, 0x4c,
    };
    // Mdl Name space
    // "org.iso.18013.5.1" - nameSpaces
    public final byte[] mdlNameSpace = {0x71, 0x6F, 0x72, 0x67, 0x2E, 0x69, 0x73, 0x6F, 0x2E,
    ...
    public final short[] STRUCT_MDOC = {
        ...
        CBOR_TEXT_STR,
        KEY_ISSUER_SIGNED,
        CBOR_MAP,  // TODO in future we may want to decode this
        KEY_DEVICE_SIGNED,
        CBOR_MAP,  // TODO in future we may want to decode this recursively. For
        //  this we can use the key id to getStructure and recurse.
        KEY_ERRORS,
        CBOR_MAP,
    };
    public final short[] STRUCT_DEVICE_SIGNED = {
        KEY_NAME_SPACES, CBOR_SEMANTIC_TAG, KEY_DEVICE_AUTH,
        CBOR_NIL,  // This is actually a map but for document being provisioned this
                   // will always be nil
    };
    ...
    public final short[] STRUCT_DEVICE_AUTH = {
        KEY_DEVICE_SIGNATURE,
        CBOR_ARRAY,
        KEY_DEVICE_MAC,
        CBOR_ARRAY,
    };
    public final short[] STRUCT_ITEMS_REQUEST = {
        KEY_DOC_TYPE, CBOR_TEXT_STR, KEY_NAME_SPACES, CBOR_MAP, KEY_REQUEST_INFO, CBOR_MAP,
    };
     ...
     * NameSpace = String DataElementIdentifier = String DigestID = uint IssuerAuth = COSE_Sign1 ;
     * The payload is MobileSecurityObjectBytes IssuerSignedItemBytes = #6.24(bstr .cbor
     * IssuerSignedItem) IssuerSignedItem = { "digestID" : uint, ; Digest ID for issuer data auth
     * "random" : bstr, ; Random value for issuer data auth "elementIdentifier" :
     * DataElementIdentifier, ; Data element identifier "elementValue" : NULL ; Placeholder for Data
     * element value }
     */
    public final short[] STRUCT_STATIC_AUTH_DATA = {
        KEY_DIGEST_MAPPING, CBOR_MAP, KEY_ISSUER_AUTH, CBOR_MAP,  // Check whether this is an array
    };

    public final short KEY_RANDOM = (short)(MDL_KEY_OFFSET + 26);
    public final short[] STRUCT_ISSUER_SIGNED_ITEM = {
        KEY_DIGEST_ID, CBOR_UINT,     KEY_RANDOM,   CBOR_BINARY_STR,
        KEY_ELEM_ID,   CBOR_TEXT_STR, KEY_ELEM_VAL, CBOR_ANY,
    };
     ...
     * + IssuerSignedItemBytes ] } ; Defined in ISO 18013-5 ; NameSpace = String
     * DataElementIdentifier = String DigestID = uint IssuerAuth = COSE_Sign1 ; The payload is
     * MobileSecurityObjectBytes IssuerSignedItemBytes = #6.24(bstr .cbor IssuerSignedItem)
    ...
    public final short[] STRUCT_CRED_DATA = {
        KEY_DOC_TYPE,    CBOR_TEXT_STR, KEY_ISSUER_NS,     CBOR_MAP,
        KEY_ISSUER_AUTH, CBOR_ARRAY,    KEY_READER_ACCESS, CBOR_ARRAY,
    };

    // Fixed arrays of strings - along with text string header
    // "eReaderKey"
    public final byte[] session_eReaderKey = {0x6A, 0x65, 0x52, 0x65, 0x61, 0x64,
                                              0x65, 0x72, 0x4b, 0x65, 0x79};
    // "status"
    ...
    // "docRequests"
    public final byte[] docRequests = {0x6B, 0x64, 0x6f, 0x63, 0x52, 0x65,
                                       0x71, 0x75, 0x65, 0x73, 0x74, 0x73};
    // "docType"
    public final byte[] docType = {0x67, 0x64, 0x6f, 0x63, 0x54, 0x79, 0x70, 0x65};
    // "issuerSigned"
    public final byte[] issuerSigned = {0x6C, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72,
                                        0x53, 0x69, 0x67, 0x6e, 0x65, 0x64};
    // "issuerAuth"
    public final byte[] issuerAuth = {0x6A, 0x69, 0x73, 0x73, 0x75, 0x65,
                                      0x72, 0x41, 0x75, 0x74, 0x68};
    // "deviceSigned"
    public final byte[] deviceSigned = {0x6C, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65,
                                        0x53, 0x69, 0x67, 0x6e, 0x65, 0x64};
    // "errors"
    public final byte[] errors = {0x66, 0x65, 0x72, 0x72, 0x6F, 0x72, 0x73};
    // "nameSpaces"
    public final byte[] nameSpaces = {0x6A, 0x6e, 0x61, 0x6d, 0x65, 0x53,
                                      0x70, 0x61, 0x63, 0x65, 0x73};
    // "deviceAuth"
    public final byte[] deviceAuth = {0x6A, 0x64, 0x65, 0x76, 0x69, 0x63,
                                      0x65, 0x41, 0x75, 0x74, 0x68};
    // "readerAuth"
    public final byte[] readerAuth = {0x6A, 0x72, 0x65, 0x61, 0x64, 0x65,
                                      0x72, 0x41, 0x75, 0x74, 0x68};
    // "itemsRequest"
    public final byte[] itemsRequest = {0x6C, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x52,
                                        0x65, 0x71, 0x75, 0x65, 0x73, 0x74};
    // "requestInfo"
    public final byte[] requestInfo = {0x6B, 0x72, 0x65, 0x71, 0x75, 0x65,
                                       0x73, 0x74, 0x49, 0x6e, 0x66, 0x6f};
    // "deviceSignature"
    public final byte[] deviceSignature = {0x6F, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53,
    ...
    public final byte[] deviceAuthentication = {0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
                                                0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
                                                0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e};
    // "ReaderAuthentication"
    public final byte[] readerAuthentication = {0x74, 0x52, 0x65, 0x61, 0x64, 0x65, 0x72,
                                                0x41, 0x75, 0x74, 0x68, 0x65, 0x6E, 0x74,
                                                0x69, 0x63, 0x61, 0x74, 0x69, 0x6F, 0x6E};
    // "digestIdMapping"
    public final byte[] digestIdMapping = {0x6F, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x49,
                                           0x64, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67};
    // "issuerNameSpaces"
    public final byte[] issuerNameSpaces = {
        0x70, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x4e, 0x61,
    ...
    // "elementIdentifier"
    public final byte[] elementIdentifier = {0x71, 0x65, 0x6C, 0x65, 0x6D, 0x65, 0x6E, 0x74, 0x49,
                                             0x64, 0x65, 0x6E, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72};
    // "elementValue"
    ...
    // "readerAccess"
    public final byte[] readerAccess = {0x6C, 0x72, 0x65, 0x61, 0x64, 0x65, 0x72,
    ...
    /**
     * Create Mdoc Credentials: Cbor Map { 0 : CBOR Text String name, 1 : CBOR Text String docType,
     * 2 : CBOR uint numSigningKeys, 3 : CBOR uint numUsesPerSigningKey, 4 : CBOR uint
    ...
    private final short[] STRUCT_MDOC_HAL_CMD = {
        ...
        KEY_CERT,
        CBOR_BINARY_STR,
        KEY_HAL_CMD_DOC_SLOT,
        CBOR_UINT,
        KEY_TEST_CREDENTIAL,
        CBOR_UINT,
        KEY_CRED_CERT_CHALLENGE,
        CBOR_BINARY_STR,
        KEY_HAL_CMD_DOC_TYPE,
        CBOR_BINARY_STR,
        KEY_HAL_CMD_MDOC_NUM_SIGN_KEYS,
        CBOR_UINT,
        KEY_HAL_CMD_MDOC_USERS_PER_SIGN_KEY,
        CBOR_UINT,
        KEY_HAL_CMD_MDOC_VALID_TIME,
        CBOR_BINARY_STR,
        KEY_OPERATION,
        CBOR_UINT,
        KEY_CRED_DATA,
    ...
    public MdlSpecifications() { mDecoder = new CBORDecoder(); }
    ...
    public short decodeStructure(short[] reqType, short[] retStructure, byte[] buf, short index,
                                 short length) {
        ...
        while (numElements > 0) {
            short rowIndex =
                getKey(reqType, mDecoder.getBuffer(),
