...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::getHardwareInfo(RpcHardwareInfo* info) {
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::generateEcdsaP256KeyPair(
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::beginSendData(
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::updateMacedKey(
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::finishSendData(
...
ScopedAStatus
JavacardRemotelyProvisionedComponent3Device::getDiceCertChain(std::vector<uint8_t>& diceCertChain) {
    uint32_t respFlag = 0;
    do {
...
ScopedAStatus
JavacardRemotelyProvisionedComponent3Device::getUdsCertsChain(std::vector<uint8_t>& udsCertsChain) {
    uint32_t respFlag = 0;
    do {
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::generateCertificateRequest(
...
ScopedAStatus JavacardRemotelyProvisionedComponent3Device::generateCertificateRequestV2(
    const std::vector<MacedPublicKey>& keysToSign, const std::vector<uint8_t>& challenge,
