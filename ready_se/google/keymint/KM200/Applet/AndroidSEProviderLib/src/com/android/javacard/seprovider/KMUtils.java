...
public class KMUtils {
  ...
  public final byte[] oneHourMsec = {0, 0, 0, 0, 0, 0x36, (byte) 0xEE, (byte) 0x80}; // 3600000 msec
  ...
  public final byte[] yearMsec = {0, 0, 0, 0x07, 0x57, (byte) 0xB1, 0x2C, 0x00}; // 31536000000
  // Leap year(366) + 3 * 365
  public final byte[] fourYrsMsec = {0, 0, 0, 0x1D, 0x63, (byte) 0xEB, 0x0C, 0x00}; // 126230400000
  ...
  // msec
  public final byte[] febMonthLeapMSec = {0, 0, 0, 0, (byte) 0x95, 0x58, 0x6C, 0x00}; // 2505600000
  public final byte[] febMonthMsec = {0, 0, 0, 0, (byte) 0x90, 0x32, 0x10, 0x00}; // 2419200000
  ...
  public short convertToDate(byte[] time, short timeOff, short timeLen, byte[] scratchPad) {
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, dec319999Ms, (short) 0, UINT8) > 0) {
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, fourYrsMsec, (short) 0, UINT8) >= 0) {
    ...
    for (; yrsCount <= roundedBaseYear; yrsCount++) {
      ...
      if ((unsignedByteArrayCompare(scratchPad, inputOffset, yearMillis, (short) 0, UINT8) < 0)) {
        break;
      }
    ...
    for (; monthCount <= 12; monthCount++) {
      ...
      if ((unsignedByteArrayCompare(scratchPad, inputOffset, monthMillis, (short) 0, UINT8) < 0)) {
        break;
      }
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, oneDayMsec, (short) 0, UINT8) >= 0) {
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, oneHourMsec, (short) 0, UINT8) >= 0) {
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, oneMinMsec, (short) 0, UINT8) >= 0) {
    ...
    if (unsignedByteArrayCompare(scratchPad, inputOffset, oneSecMsec, (short) 0, UINT8) >= 0) {
    ...
    if (yrsCount < year2050) {
      Util.arrayCopyNonAtomic(
          scratchPad, (short) (inputOffset + 2), scratchPad, inputOffset, (short) (len - 2)); // YY
      len -= 2;
    }
    return len;
  }
  ...
  private short getNearestLowerHundredthBoundMills(
    ...
    if (unsignedByteArrayCompare(scratchPad, timeOff, firstJan2000MSec, (short) 0, (short) 8) < 0) {
      start = year2000;
      end = year2000;
      currentTimeMillis = firstJan2000MSec;
      prevTimeMillis = firstJan1970MSec;
    } else if (unsignedByteArrayCompare(scratchPad, timeOff, firstJan4000MSec, (short) 0, (short) 8)
        < 0) {
      start = year2000;
      end = year4000;
      currentTimeMillis = firstJan2000MSec;
      prevTimeMillis = firstJan2000MSec;
    } else if (unsignedByteArrayCompare(scratchPad, timeOff, firstJan6000MSec, (short) 0, (short) 8)
        < 0) {
      start = year4000;
      end = year6000;
      currentTimeMillis = firstJan4000MSec;
      prevTimeMillis = firstJan4000MSec;
    } else if (unsignedByteArrayCompare(scratchPad, timeOff, firstJan8000MSec, (short) 0, (short) 8)
        < 0) {
      start = year6000;
      end = year8000;
      currentTimeMillis = firstJan6000MSec;
      prevTimeMillis = firstJan6000MSec;
    } else if (unsignedByteArrayCompare(scratchPad, timeOff, dec319999Ms, (short) 0, (short) 8)
        <= 0) {
      start = year8000;
      end = year10000;
  ...
  public short countTemporalCount(byte[] time, short timeOff, short timeLen, byte[] scratchPad) {
    short scratchpadOff = 0;
    Util.arrayFillNonAtomic(scratchPad, scratchpadOff, (short) 24, (byte) 0);
    Util.arrayCopyNonAtomic(
        time, timeOff, scratchPad, (short) (scratchpadOff + UINT8 - timeLen), timeLen);
    Util.arrayCopyNonAtomic(
        ThirtDaysMonthMsec, (short) 0, scratchPad, (short) (scratchpadOff + 8), UINT8);
    return divide(
        scratchPad, scratchpadOff, (short) (scratchpadOff + 8), (short) (scratchpadOff + 16));
  }
  ...
  public short convertToMilliseconds(byte[] time, short timeOff, short timeLen, byte[] scratchPad) {
    ...
    while (index < length) {
      Util.arrayFillNonAtomic(scratchPad, scratchPadOff, (short) 24, (byte) 0);
      Util.arrayCopyNonAtomic(
          time, timeOff, scratchPad, (short) (scratchPadOff + UINT8 - timeLen), UINT8);
      ...
      Util.arrayCopyNonAtomic(
          scratchPad, (short) (scratchPadOff + 16), scratchPad, (short) (scratchPadOff + 8), UINT8);
      index++;
    }
    Util.arrayCopyNonAtomic(
        scratchPad, (short) (scratchPadOff + 8), scratchPad, scratchPadOff, UINT8);
    return UINT8;
  }
