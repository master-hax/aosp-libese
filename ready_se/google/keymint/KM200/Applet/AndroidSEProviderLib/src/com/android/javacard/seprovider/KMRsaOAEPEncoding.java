...
public class KMRsaOAEPEncoding extends Cipher {
  ...
  public short doFinal(
    ...
    return rsaOAEPDecode(inBuff, inOffset, (short) (len - 1), outBuff, outOffset);
  }
  ...
  private short rsaOAEPDecode(
      byte[] encodedMsg, short encodedMsgOff, short encodedMsgLen, byte[] msg, short offset) {
    MessageDigest.OneShot md = null;
