...
public class KMCose {
  ...
  public static final byte[] EMPTY_MAC_KEY = {
    0x45, 0x6d, 0x70, 0x74, 0x79, 0x20, 0x4d, 0x41, 0x43, 0x20, 0x6b, 0x65, 0x79
  }; // "Empty MAC key"
  ...
  public static final byte[] CONFIG_DESCRIPTOR = {
    (byte) 0xFF, (byte) 0xB8, (byte) 0xBB, (byte) 0xAC
  };
  public static final byte[] AUTHORITY_HASH = {(byte) 0xFF, (byte) 0xB8, (byte) 0xBB, (byte) 0xAB};
  public static final byte[] AUTHORITY_DESCRIPTOR = {
    (byte) 0xFF, (byte) 0xB8, (byte) 0xBB, (byte) 0xAA
  };
  ...
  public static final byte[] MAC_DERIVE_KEY_CTX = {
    0x4B, 0x65, 0x79, 0x20, 0x74, 0x6F, 0x20, 0x4D, 0x41, 0x43, 0x20, 0x70, 0x75, 0x62, 0x6C, 0x69,
    0x63, 0x20, 0x6B, 0x65, 0x79, 0x73
  }; // "Key to MAC public keys"

  public static final short[] coseKeyConst = {
  ...
  public static final short[] coseHeaderConst = {
