...
public class FiraSpecs {
    ...
    // are always 2 bytes and length is either 1 byte of 3 bytes (first byte is oxFF).
    // In BER TLV, Tags can very from 1 to n bytes and the length is encoded differently.
    // Also in BER TLV the 0 and 0xFF is not used as Tags and they can occur between two
    // BER TLV DOs.
