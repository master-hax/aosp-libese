...
public class FiraRepository {
    ...
    public static void init() {
        ...
        // NOTE: for upgrade if new slots are added then they have to be added at the end.
        // The old data must be backed up.
    ...
    // IMPL_STATIC_SLOT_MAX_COUNT to IMPL_STATIC_SLOT_MAX_COUNT + IMPL_DYNAMIC_SLOT_MAX_COUNT
