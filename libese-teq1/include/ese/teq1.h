...
#define teq1_trace_header() ALOGV("%-20s --- %20s", "Interface", "Card")
#define teq1_trace_transmit(PCB) ALOGV("%-20s --> %20s", teq1_pcb_to_name(PCB), "")
#define teq1_trace_receive(PCB) ALOGV("%20s <-- %20s", "", teq1_pcb_to_name(PCB))
