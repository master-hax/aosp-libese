...
public class KMIntegerArrayTag extends KMTag {
  ...
  public short getTagType() {
    return Util
        .getShort(heap, (short) (instanceTable[KM_INTEGER_ARRAY_TAG_OFFSET] + TLV_HEADER_SIZE));
  }

  public short getKey() {
    return Util
        .getShort(heap, (short) (instanceTable[KM_INTEGER_ARRAY_TAG_OFFSET] + TLV_HEADER_SIZE + 2));
  }

  public short getValues() {
    return Util
        .getShort(heap, (short) (instanceTable[KM_INTEGER_ARRAY_TAG_OFFSET] + TLV_HEADER_SIZE + 4));
  }
