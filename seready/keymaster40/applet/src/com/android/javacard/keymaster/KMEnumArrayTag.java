...
public class KMEnumArrayTag extends KMTag {
  ...
  public short getKey() {
    return Util
        .getShort(heap, (short) (instanceTable[KM_ENUM_ARRAY_TAG_OFFSET] + TLV_HEADER_SIZE + 2));
  }
  ...
  public short getValues() {
    return Util
        .getShort(heap, (short) (instanceTable[KM_ENUM_ARRAY_TAG_OFFSET] + TLV_HEADER_SIZE + 4));
  }
