...
#ifndef KEYMASTER_V4_0_JAVACARD_COMMONUTILS_H_
#define KEYMASTER_V4_0_JAVACARD_COMMONUTILS_H_
...
ErrorCode getCertificateChain(std::vector<uint8_t>& chainBuffer,
...
#endif  // KEYMASTER_V4_0_JAVACARD_COMMONUTILS_H_
